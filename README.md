...
## Contributing
Video.js is a free and open source library, and we appreciate any help you're willing to give. Check out the [contributing guide](.github/CONTRIBUTING.md).

_Video.js uses [BrowserStack](https://browserstack.com) for compatibility testing_
## Building your own Video.js from source
To build your own custom version read the section on [contributing code](.github/CONTRIBUTING.md#contributing-code) and ["Building your own copy"](.github/CONTRIBUTING.md#building-your-own-copy-of-videojs) in the contributing guide.
## License
