...
vjs.Slider.prototype.update = function(){
  ...
  this.updateHandlePosition(progress);

  // Convert to a percentage for setting
  var percentage = vjs.round(progress * 100, 2) + '%';
