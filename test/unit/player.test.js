...
test('should accept options from multiple sources and override in correct order', function(){
  ...
  let player2 = new Player(tag2, { techOrder: ['html5'] });
  ...
  let player3 = new Player(tag3, { techOrder: ['html5'], 'attr': 'fdsa' });
...
test('should wrap the original tag in the player div', function(){
  ...
  var player = new Player(tag, { techOrder: ['html5'] });
  var el = player.el();
...
test('should register players with generated ids', function(){
  ...
  player = new Player(video, { techOrder: ['html5'] });
  id = player.el().id;
