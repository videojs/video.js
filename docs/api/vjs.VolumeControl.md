...
__DEFINED IN__: [src/js/control-bar/volume-control.js#L7](https://github.com/videojs/video.js/blob/master/src/js/control-bar/volume-control.js#L7)  
...
_defined in_: [src/js/control-bar/volume-control.js#L9](https://github.com/videojs/video.js/blob/master/src/js/control-bar/volume-control.js#L9)
