...
__DEFINED IN__: [src/js/control-bar/volume-control.js#L44](https://github.com/videojs/video.js/blob/master/src/js/control-bar/volume-control.js#L44)  
...
_defined in_: [src/js/control-bar/volume-control.js#L46](https://github.com/videojs/video.js/blob/master/src/js/control-bar/volume-control.js#L46)
