...
__DEFINED IN__: [src/js/control-bar/time-display.js#L79](https://github.com/videojs/video.js/blob/master/src/js/control-bar/time-display.js#L79)  
...
_defined in_: [src/js/control-bar/time-display.js#L81](https://github.com/videojs/video.js/blob/master/src/js/control-bar/time-display.js#L81)
