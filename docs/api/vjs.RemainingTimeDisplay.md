...
__DEFINED IN__: [src/js/control-bar/time-display.js#L99](https://github.com/videojs/video.js/blob/master/src/js/control-bar/time-display.js#L99)  
...
_defined in_: [src/js/control-bar/time-display.js#L101](https://github.com/videojs/video.js/blob/master/src/js/control-bar/time-display.js#L101)
