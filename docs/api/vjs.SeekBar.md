...
__DEFINED IN__: [src/js/control-bar/progress-control.js#L32](https://github.com/videojs/video.js/blob/master/src/js/control-bar/progress-control.js#L32)  
...
_defined in_: [src/js/control-bar/progress-control.js#L34](https://github.com/videojs/video.js/blob/master/src/js/control-bar/progress-control.js#L34)
...
_inherited from_: [src/js/slider.js#L199](https://github.com/videojs/video.js/blob/master/src/js/slider.js#L199)
